    ...
    def _process_with_ai(self, query: str) -> dict:
        ...
        try:
            ...
            system_prompt = (
                ...
                "**POD OPERATIONS:**\n"
                "- 'show me all pods' → Use get_pods\n"
                "- 'list pods in default namespace' → Use get_pods with namespace=default\n"
                "- 'get pod named X' → Use get_pods with name=X\n"
                "- 'create pod named X' → Use run_container_in_pod with name=X, image=nginx\n"
                "- 'delete pod X' → Use execute_kubectl with name=X\n"
                "- 'logs from pod X' → Use get_pod_logs with name=X\n"
                "- 'execute command Y in pod X' → Use exec_into_pod\n\n"
